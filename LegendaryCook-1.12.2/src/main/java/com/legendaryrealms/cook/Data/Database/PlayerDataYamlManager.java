...
public class PlayerDataYamlManager {
    ...
    {
        for (String FileName: CooksManager.getFiles("./plugins/LegendaryAlchemy/Data"))
        {
            File file=new File("./plugins/LegendaryAlchemy/Data",FileName);
            YamlConfiguration yml=YamlConfiguration.loadConfiguration(file);
            String p=FileName.replace(".yml","");
